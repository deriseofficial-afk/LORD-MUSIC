...
from NOBITAMUSIC.core.userbot import *
...
BOT_LIST = ["NOBITA_MUSICS_BOT", "NOBITA_MUSIC_TG_BOT", "NOBITA_MOVIES_BOT", "NOBITA_CHATBOT", "StrangerHackBot"]
